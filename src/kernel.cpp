...
extern const int nStakeMaxAge;
extern const int nStakeTargetSpacing;

using namespace std;


// Protocol switch time for fixed kernel modifier interval
unsigned int nModifierSwitchTime  = 1613763200;
unsigned int nModifierTestSwitchTime = 1597520000;
