...
static const uint256 hashGenesisBlock("0x00000954f0c22a62e69c99bf09ddfaff284c358974d367b8146d1f6217443c89");
static const uint256 hashGenesisBlockTestNet("0x000e08b268914194dfac670411e1aabe4d68e5e879b4bb0764f4196009a58ad1");

const int nStakeTargetSpacing = 1 * 60; // 1 minute spacing
const int nStakeMinAge = 60 * 60 * 24; // 1 day as zero time weight
const int nStakeMaxAge = 60 * 60 * 24 * 30; // 30 days as full weight

inline int64_t PastDrift(int64_t nTime)   { return nTime - 3 * 60 * 60; } // up to 3 hours from the past
inline int64_t FutureDrift(int64_t nTime) { return nTime + 3 * 60 * 60; } // up to 3 hours from the future
...
extern const int nStakeMinAge;
extern const int nCoinbaseMaturity;
