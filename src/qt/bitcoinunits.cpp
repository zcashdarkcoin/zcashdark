...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("ZECD");
    case mBTC: return QString("mZECD");
    case uBTC: return QString::fromUtf8("μZECD");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("ZcashDARKs"));
    case mBTC: return QString(QObject::tr("Milli-ZcashDARKs (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-ZcashDARKs (1 / 1,000,000)"));
    default: return QString("???");
    }
}
