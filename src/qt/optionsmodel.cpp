...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("strThirdPartyTxUrls")) {
        if(fTestNet)
            ...
            settings.setValue("strThirdPartyTxUrls", "https://bitinfocharts.com/zcashdark/tx/%s|https://coinplorer.com/ZECD/Transactions/%s|https://explorer.novaco.in/tx/%s");
    }
    strThirdPartyTxUrls = settings.value("strThirdPartyTxUrls", "https://bitinfocharts.com/zcashdark/tx/%s|https://coinplorer.com/ZECD/Transactions/%s|https://explorer.novaco.in/tx/%s").toString();
