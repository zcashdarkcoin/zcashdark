    ...
    model(0)
{
    ...
    ui->addressIn_SM->setPlaceholderText(tr("Enter a ZcashDARK address (e.g. ZCvGZ9UycLPsF86ZVGLc16L2n6bhVnxS3e)"));
    ui->signatureOut_SM->setPlaceholderText(tr("Click \"Sign Message\" to generate signature"));

    ui->addressIn_VM->setPlaceholderText(tr("Enter a ZcashDARK address (e.g. ZCvGZ9UycLPsF86ZVGLc16L2n6bhVnxS3e)"));
    ui->signatureIn_VM->setPlaceholderText(tr("Enter ZcashDARK signature"));
#endif
